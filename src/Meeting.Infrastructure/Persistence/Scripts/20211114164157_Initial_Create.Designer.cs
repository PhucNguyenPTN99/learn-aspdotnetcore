...
namespace Meeting.Infrastructure.Persistence.Scripts
{
    ...
    [Migration("20211114164157_Initial_Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meeting.Core.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("Meeting.Core.Entities.Post", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Meeting.Core.Entities.Post", b =>
                {
                    b.HasOne("Meeting.Core.Entities.Category", "Category")
                        .WithMany("Posts")
